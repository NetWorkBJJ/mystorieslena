...
/**
 * Etapa 5 — Revisor (Romance de Máfia).
 *
 * Editor literário rigoroso especializado em dark romance de máfia. Revisa
 * o roteiro do Step 4 cruzando com Premissa e Estruturas aprovadas. Aplica
 * 4 graus de classificação (🟢 não interfere, 🟡 atenção, 🔴 interfere,
 * 💀 gravíssimo — note que difere do milionário no terceiro/quarto graus).
