/**
 * Categoria: Romance de Máfia (estilo Helô Stories™).
 *
...
export const mafiaAgents: Record<StepId, Agent> = {
...
export const mafiaEscritaSystemPrompt = ESCRITA_SYSTEM_PROMPT;

export const mafiaRevisorExtract = {
